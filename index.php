...
if (!empty($_SESSION['active'])) {
    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['usuario']) || empty($_POST['clave'])) {
            ...
            $query = mysqli_query($conexion, "SELECT * FROM users WHERE user = '$user' AND password = '$clave' AND status = 1");
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img-thumbnail" src="assets/img/logo.jpeg" width="100">
